...
可在 [GitHub Releases 下载 v0.2.5 Windows x64 测试安装包](https://github.com/ningbainb/Dcode/releases/tag/v0.2.5)。v0.2.1 用户需先手动安装 v0.2.2 或更新版本；v0.2.2 及后续版本可在应用内检查更新。安装及真实账号的在线链路尚待验收，使用前请阅读[发行说明与 SHA-256](docs/releases/v0.2.5.md)。
