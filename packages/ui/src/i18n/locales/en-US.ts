...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like Dcode to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let Dcode remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting Dcode",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen Dcode.",
  ...
  "startup.global.starting_services": "Starting Dcode",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "Dcode will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another Dcode or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen Dcode. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen Dcode to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen Dcode.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a Dcode restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into Dcode",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to Dcode and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to Dcode",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to Dcode",
  "login.description": "Connect your account to start using Dcode",
  ...
  "logout.confirm.title": "Disconnect and restart Dcode?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only Dcode Agent writes model-io)",
  ...
  "forceUpdate.title": "Update Dcode to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart Dcode to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the Dcode CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "Dcode checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the Dcode terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While Dcode is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the Dcode installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.zcodeImport.title": "Import ZCode sessions",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching Dcode task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by Dcode",
  ...
  "resourceManager.storage.diskUsage": "Dcode uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the Dcode desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Dcode could not verify its Windows secure import component. Reinstall or update Dcode before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, Dcode will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.host.activeDescription":
    "Dcode provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This Dcode Agent cannot refresh OAuth status. Upgrade or restart Dcode, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to Dcode to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into Dcode",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to Dcode 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by Dcode automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in Dcode.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. Dcode uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in Dcode after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "Dcode MCP",
  ...
  "sidebar.usage.plan.mcp": "Dcode MCP",
  "sidebar.usage.plan.zcodeMcp": "Dcode MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for Dcode built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into Dcode. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. Dcode follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into Dcode",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by Dcode Agent.",
  ...
  "settings.dshPlugins.intro": "Enable local tools for the Dcode Agent. Plugins are off by default and become available to new DeepSeek Harness sessions through MCP.",
  "settings.dshPlugins.browser.title": "Browser control",
  "settings.dshPlugins.browser.description": "Let the Agent browse and interact in an isolated Edge session. Microsoft Edge is required; your everyday browser login is not shared.",
  "settings.dshPlugins.browser.source": "Microsoft Playwright MCP · Open source",
  "settings.dshPlugins.computer.title": "Computer control · Experimental",
  "settings.dshPlugins.computer.description": "Let the Agent inspect windows, find controls, and operate the desktop through Windows UI Automation. Python 3.12+ required.",
  "settings.dshPlugins.computer.source": "windows-gui-mcp / pywinauto · Open source",
  "settings.dshPlugins.missing": "Runtime component missing",
  "settings.dshPlugins.windowsOnly": "Currently available on Windows only",
  "settings.dshPlugins.install": "Install component",
  "settings.dshPlugins.installing": "Installing…",
  "settings.dshPlugins.restartHint": "Changing a switch restarts the Agent runtime and may interrupt active tasks.",
  ...
  "settings.plugins.store.subtitle":
    "Extend Dcode with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into Dcode and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. Dcode follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into Dcode",
  ...
  "settings.commands.description":
    "Manage Dcode Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "Dcode Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into Dcode. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. Dcode follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into Dcode",
  ...
  "settingsSync.action.finish": "Start using Dcode",
  "settingsSync.agent.zcode": "Dcode Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current Dcode settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to Dcode",
  ...
  "onboarding.welcome.title": "Welcome to Dcode",
  "onboarding.welcome.start": "Start Dcode",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while Dcode imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "Dcode will copy {source} to {target}.\nIf the target file already exists, the Dcode default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask Dcode anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask Dcode anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, Dcode will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want Dcode to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart Dcode app and retry, or ask Dcode to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with Dcode in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for Dcode: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with Dcode in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current Dcode Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'Dcode MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No Dcode MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "Dcode",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Dcode Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while Dcode is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task Dcode can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Dcode Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "Dcode Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart Dcode",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart Dcode to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified Dcode plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "Dcode will verify the Computer Use tools against the exact session when your first session starts.",
