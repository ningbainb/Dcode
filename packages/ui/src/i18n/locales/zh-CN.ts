...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 Dcode 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 Dcode 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 Dcode 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 Dcode",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 Dcode。",
  ...
  "startup.global.starting_services": "正在启动 Dcode",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 Dcode。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 Dcode 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 Dcode",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 Dcode 后重试",
  ...
  "login.title": "欢迎来到 Dcode",
  "login.description": "连接账号，开始使用 Dcode",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 Dcode？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 Dcode Agent 会落盘 model-io）",
  ...
  "forceUpdate.title": "需要升级 Dcode 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 Dcode 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 Dcode CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 Dcode 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 Dcode 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 Dcode 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "resourceManager.storage.summaryTotal": "Dcode 总占用",
  ...
  "resourceManager.storage.diskUsage": "Dcode 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 Dcode 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Dcode 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 Dcode。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。Dcode 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 Dcode 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 Dcode Agent 不支持 OAuth 状态刷新。请升级或重启 Dcode，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 Dcode。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 Dcode",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 Dcode 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 Dcode 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 Dcode 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。Dcode 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。Dcode 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 Dcode 即可继续编码。",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "Dcode 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 Dcode。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。Dcode 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 Dcode",
  ...
  "settings.subagents.description": "管理 Dcode Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.dshPlugins.intro": "为 Dcode Agent 启用本机工具。插件默认关闭，启用后由 DeepSeek Harness 通过 MCP 提供给新会话。",
  "settings.dshPlugins.browser.title": "浏览器控制",
  "settings.dshPlugins.browser.description": "让 Agent 在独立的 Edge 会话中打开网页、读取页面并交互；需要本机 Edge，不会读取日常浏览器的登录状态。",
  "settings.dshPlugins.browser.source": "Microsoft Playwright MCP · 开源",
  "settings.dshPlugins.computer.title": "电脑控制 · 实验性",
  "settings.dshPlugins.computer.description": "让 Agent 通过 Windows UI Automation 查看窗口、查找控件并操作桌面。需 Python 3.12+。",
  "settings.dshPlugins.computer.source": "windows-gui-mcp / pywinauto · 开源",
  "settings.dshPlugins.missing": "运行组件缺失",
  "settings.dshPlugins.windowsOnly": "当前仅支持 Windows",
  "settings.dshPlugins.install": "安装运行组件",
  "settings.dshPlugins.installing": "正在安装…",
  "settings.dshPlugins.restartHint": "更改开关会重启 Agent 运行时，正在执行的任务可能中断。",
  ...
  "settings.plugins.store.subtitle": "用插件为 Dcode 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 Dcode，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。Dcode 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 Dcode",
  ...
  "settings.commands.description":
    "管理 Dcode Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 Dcode。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。Dcode 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 Dcode",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 Dcode 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 Dcode",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 Dcode",
  "onboarding.welcome.start": "开始使用 Dcode",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 Dcode 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，Dcode 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 Dcode 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 Dcode 提问…",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 Dcode 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 Dcode 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 Dcode 修订后另存一版。",
  ...
  "chat.quota.mcp.quotaExhausted": "Dcode MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 Dcode MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Dcode 报错信息",
  ...
  "offPeak.keepAwakeBanner": "Dcode 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 Dcode 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Dcode 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "Dcode 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 Dcode",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 Dcode 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 Dcode 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，Dcode 会针对该会话精确验证电脑控制工具。",
